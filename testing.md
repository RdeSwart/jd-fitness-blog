...
<ins>Like Button</ins>| Click applause icon when logged IN| Number increases| Pass
<ins>Unlike Button</ins>| CLick applause icon to unlike instead| Number decreases| Pass
...
<ins>404 Page</ins>| Wrong address entered| 404 Page renders with link to go back Home| 
<ins>403 Page</ins>| Access Denied| 403 Page renders with link to go back Home| 
<ins>500 Page</ins>| Internal Server Error| 500 Page renders with link to go back Home| 
...
![Js Hint](static/images/js-hint.png)